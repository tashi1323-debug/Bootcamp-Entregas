...
Creo la carpeta Bootcamp Entregas en mi escritorio.
La abro con Vscode
Ejecuto: git init

2. Subir el repositorio a GitHub

Creo el repositorio Bootcamp-Entregas en github.
Copio la clave SSH.
Voy a vscode y ejecuto git clone (url ssh).
...
Hago un merge de main a development.
Resuelvo los conflictos aceptando el cambio
Vuelvo a ejectuar git merge development.
Ejecuto git push para subir los cambios.